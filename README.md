...
* Using this date, retrieve the last 12 months of precipitation data by querying the 12 preceding months of data. **Note** do not pass in the date as a variable to your query.
